...
class Config:
    ...
    TEST.BBOX_AUG.H_FLIP = True
    TEST.BBOX_AUG.SCALES = (800, 1000, 1200, 1400, 1600)
    TEST.BBOX_AUG.MAX_SIZE = 2000
    TEST.BBOX_AUG.SCALE_H_FLIP = True
    ...
    MODEL.RESNETS.STAGE_WITH_DCN = (False, True, True, True)
    MODEL.RESNETS.WITH_MODULATED_DCN = True
