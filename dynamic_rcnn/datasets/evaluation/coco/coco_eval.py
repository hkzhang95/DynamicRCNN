...
def do_coco_evaluation(
    ...
    if box_only:
        ...
        check_expected_results(
            res, expected_results, expected_results_sigma_tol, logger)
        if output_folder:
    ...
    logger.info(results)
    check_expected_results(
        results, expected_results, expected_results_sigma_tol, logger)
    if output_folder:
...
class COCOResults(object):
    METRICS = {
        "bbox": ["AP", "AP50", "AP75", "APs", "APm", "APl", "AR@1", "AR@10",
